...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { detail: @travel.detail, estimated_price: @travel.estimated_price, location: @travel.location, title: @travel.title, writer: @travel.writer } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { detail: @travel.detail, estimated_price: @travel.estimated_price, location: @travel.location, title: @travel.title, writer: @travel.writer } }
